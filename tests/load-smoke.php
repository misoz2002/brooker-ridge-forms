...
if(BRAH_Forms::VERSION!=='2.2.2'||!class_exists('BRAH_Client_Portal')){fwrite(STDERR,"Portal version or class mismatch.\n");exit(1);}
...
$plugin='brooker-ridge-forms/brooker-ridge-forms.php';$stale=(object)['response'=>[$plugin=>(object)['new_version'=>'2.2.2']]];$newer=(object)['response'=>[$plugin=>(object)['new_version'=>'2.2.3']]];
