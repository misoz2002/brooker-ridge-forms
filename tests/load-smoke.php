...
if(BRAH_Forms::VERSION!=='2.2.8'||!class_exists('BRAH_Client_Portal')){fwrite(STDERR,"Portal version or class mismatch.\n");exit(1);}
...
$plugin='brooker-ridge-forms/brooker-ridge-forms.php';$stale=(object)['response'=>[$plugin=>(object)['new_version'=>'2.2.8']]];$newer=(object)['response'=>[$plugin=>(object)['new_version'=>'2.2.9']]];
...
$source='<h1>Welcome to Brooker Ridge Animal Hospital – Trusted Veterinarian in Newmarket</h1>Welcome to Brooker Ridge Animal Hospital, conveniently located at 107-525 Brooker Ridge, Newmarket, Ontario.<section class="brah-seo-contact"><h2>Newmarket Veterinary Clinic Location</h2></section><script type="application/ld+json">{"@context":"https://schema.org"}</script><strong>Call us today at <a href="tel:+19058981010">905-898-1010</a> to book an appointment with our <a href="https://vetsnewmarket.com">veterinarian in Newmarket, Ontario</a>.</strong><a href="tel:+19058981010">905-898-1010</a>';
$source_clean=BRAH_Forms::clean_homepage_stored_source($source);
if(strpos($source_clean,'Welcome to')!==false||strpos($source_clean,'brah-seo-contact')!==false||strpos($source_clean,'application/ld+json')!==false||strpos($source_clean,'<strong>Call us today')!==false||substr_count($source_clean,'>905-898-1010</a>')!==1){fwrite(STDERR,"Homepage stored source cleanup failed.\n");exit(1);}
