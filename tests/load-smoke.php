...
if(BRAH_Forms::VERSION!=='2.1.4'||!class_exists('BRAH_Client_Portal')){fwrite(STDERR,"Portal version or class mismatch.\n");exit(1);}
if(empty($GLOBALS['brah_test_actions']['wp_head'])||empty($GLOBALS['brah_test_filters']['the_content'])||empty($GLOBALS['brah_test_filters']['aioseo_description'])){fwrite(STDERR,"Missing homepage SEO hooks.\n");exit(1);}
$plugin='brooker-ridge-forms/brooker-ridge-forms.php';$stale=(object)['response'=>[$plugin=>(object)['new_version'=>'2.1.4']]];$newer=(object)['response'=>[$plugin=>(object)['new_version'=>'2.1.5']]];
